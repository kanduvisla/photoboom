...
class Document extends Element
{
     ...
     * Add a SVG Element
     *
     * @param Element|\SimpleXMLElement $element
     */
    ...
    public function setDropshadow($parameters = array())
    {
        ...
        // Set the blur:
        $feGaussianBlur = new Element('feGaussianBlur',
            array(
                'result' => 'blurOut',
                'in' => 'offOut',
                'stdDeviation' => 3
    ...
    public function addUse($id, $attributes = array(), $copy = false)
    {
        ...
        if(!$copy)
        {
            ...
            $g = new Group($id.rand(100000, 999999));
            foreach($attributes as $key => $value)
            {
